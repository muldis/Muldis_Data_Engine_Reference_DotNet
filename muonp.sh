...
./Muldis_Object_Notation_Processor_Reference/Muldis.Object_Notation_Processor_Reference_App/bin/Debug/net6.0/Muldis.Object_Notation_Processor_Reference_App "$@"
