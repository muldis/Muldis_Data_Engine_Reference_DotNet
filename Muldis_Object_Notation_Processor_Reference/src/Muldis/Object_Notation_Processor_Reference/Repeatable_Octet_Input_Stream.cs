...
public class Repeatable_Octet_Input_Stream
{
    ...
    // It is implemented as a wrapper around a standard .NET/C# system-defined
    // "Stream" object which is its own source of octets.
    ...
    // The standard system-provided Stream.ReadByte()
    ...
    private Int32 part_2_source_position;
    ...
    private Int32 count_of_part_1_memory_octets_to_return_first;

    public Repeatable_Octet_Input_Stream(Stream stream_source)
    {
        if (stream_source is null)
        {
            ...
            throw new ArgumentException("Arg stream_source was null.");
        }
    ...
    public Int32 read_octet()
    {
        if (this.part_1_memory is null && this.part_2_source is null)
        {
        ...
        Int32 octet_as_int = this.part_2_source.ReadByte();
        if (octet_as_int < 0)
        {
        ...
        if (this.part_1_memory is not null)
        {
    ...
    {
        Repeatable_Octet_Input_Stream_Position_Hold hold
            = new Repeatable_Octet_Input_Stream_Position_Hold(this);
        if (this.stream_position_holds is null)
        {
            this.part_1_memory = new List<Int32>();
            this.stream_position_holds = new Dictionary<Repeatable_Octet_Input_Stream_Position_Hold, Int32>();
        }
        this.stream_position_holds.Add(hold, this.part_2_source_position);
        return hold;
    }
        ...
        Repeatable_Octet_Input_Stream_Position_Hold hold)
    {
        if (hold is null)
        {
            throw new ArgumentException("Arg hold is null.");
        }
        if (!Object.ReferenceEquals(hold.stream_position_held_in(), this))
        {
        ...
        Int32 our_held_position
            = this.stream_position_holds[hold];
        this.count_of_part_1_memory_octets_to_return_first
        ...
        Repeatable_Octet_Input_Stream_Position_Hold hold)
    {
        ...
        if (this.stream_position_holds.Count == 0)
        {
