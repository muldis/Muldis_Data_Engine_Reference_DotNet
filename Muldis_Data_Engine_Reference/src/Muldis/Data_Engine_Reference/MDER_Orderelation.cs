...
public sealed class MDER_Orderelation : MDER_Any
{
    ...
    internal MDER_Orderelation(MDER_Machine machine, MDER_Heading heading, MDER_Array body)
    {
    ...
    internal Boolean _MDER_Orderelation__same(MDER_Orderelation topic_1)
    {
        MDER_Orderelation topic_0 = this;
