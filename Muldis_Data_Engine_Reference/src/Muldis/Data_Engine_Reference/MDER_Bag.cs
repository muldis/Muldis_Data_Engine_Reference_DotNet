...
public class MDER_Bag : MDER_Any
{
    ...
    internal MDER_Bag(MDER_Machine machine, Internal_MDER_Array_Struct tree_root_node)
    ...
    internal String _as_MUON_Bag_artifact(String indent)
    {
        ...
        Internal_MDER_Array_Struct node = this.tree_root_node;
        ...
        Internal_MDER_Array_Struct node_0, Internal_MDER_Array_Struct node_1)
    {
        ...
        if (node_0.local_symbolic_type == Internal_Symbolic_Array_Type.Indexed
            && node_1.local_symbolic_type == Internal_Symbolic_Array_Type.Indexed)
        {
